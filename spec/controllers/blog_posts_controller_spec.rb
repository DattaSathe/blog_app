  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved blog_post as @blog_post" do
        ...
        post :create, {:blog_post => { "user_id" => "invalid value" }}, valid_session
        assigns(:blog_post).should be_a_new(BlogPost)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested blog_post" do
        ...
        BlogPost.any_instance.should_receive(:update_attributes).with({ "user_id" => "1" })
        put :update, {:id => blog_post.to_param, :blog_post => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the blog_post as @blog_post" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        BlogPost.any_instance.stub(:save).and_return(false)
        put :update, {:id => blog_post.to_param, :blog_post => { "user_id" => "invalid value" }}, valid_session
        assigns(:blog_post).should eq(blog_post)
      end
